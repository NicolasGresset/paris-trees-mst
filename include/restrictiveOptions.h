...
/**
 * @brief Cette fonction met les arbres concernés par les options dans treesSelection
 * 
 ...
 * @param treesSelection tableau où sont stockées les informations sur les arbres après le tri selon les options
